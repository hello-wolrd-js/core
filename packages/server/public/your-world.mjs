...
var a = null;
let $ = null, V = null, f = null, u = null, g = null, x = 0;
function Q(e, s) {
  const t = f, n = a, l = e.length === 0, i = s === void 0 ? n : s, r = l ? U : {
    owned: null,
    cleanups: null,
...
function O(e, s, t) {
  ...
  return (!e.comparator || !e.comparator(n, s)) && (e.value = s, e.observers && e.observers.length && b(() => {
    for (let l = 0; l < e.observers.length; l += 1) {
      ...
      r && $.disposed.has(i), (r ? !i.tState : !i.state) && (i.pure ? u.push(i) : g.push(i), i.observers && F(i)), r || (i.state = w);
    }
    if (u.length > 1e6)
      throw u = [], new Error();
  }, !1)), s;
...
function J(e, s, t) {
  ...
  try {
    ...
    return e.pure && (e.state = w, e.owned && e.owned.forEach(v), e.owned = null), e.updatedAt = t + 1, I(r);
  } finally {
    f = i, a = l;
  }
  (!e.updatedAt || e.updatedAt <= t) && (e.updatedAt != null && "observers" in e ? O(e, n) : e.value = n, e.updatedAt = t);
}
  ...
  for (; r < l || o < i; ) {
    ...
    if (l === r) {
      ...
      if (h != null)
        if (o < h && h < i) {
          let d = r, m = 1, _;
          for (; ++d < l && d < i && !((_ = p.get(s[d])) == null || _ !== h + m); )
            m++;
          if (m > h - o) {
            const G = s[r];
            for (; o < h; )
              e.insertBefore(t[o++], G);
          } else
...
function te(e, s, t) {
  ...
  }, i = s ? () => C(() => document.importNode(n || (n = l()), !0)) : () => (n || (n = l())).cloneNode(!0);
...
var le = /* @__PURE__ */ te('<div class=p-10><div>count:</div><button class=btn>+</button><button class="btn ml-1">-');
const ie = () => {
  const [e, s] = W(0), t = () => {
    s(e() + 1);
  }, n = () => {
  ...
  return (() => {
    var l = le(), i = l.firstChild;
    i.firstChild;
    var r = i.nextSibling, o = r.nextSibling;
